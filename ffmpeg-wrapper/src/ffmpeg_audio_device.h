 ...
 *  tree.
 * 
 *  Referenced from modules/audio_device/dummy/file_audio_device.h
 */

#ifndef AUDIO_DEVICE_FFMPEG_AUDIO_DEVICE_H_
#define AUDIO_DEVICE_FFMPEG_AUDIO_DEVICE_H_
...
class FFmpegAudioDevice : public webrtc::AudioDeviceGeneric {
 public:
...
#endif  // AUDIO_DEVICE_FFMPEG_AUDIO_DEVICE_H_
